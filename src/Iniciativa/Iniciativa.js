...
function Iniciativa(){
    ...
    const retrieveIniciativa = () => {
        ...
        .then((response) => {
            ...
            var inisOrdenadasSucesso = inis.sort((a,b) =>{
                return a.tipoSucesso > b.tipoSucesso ? -1 : a.tipoSucesso < b.tipoSucesso ? 1 : 0;
            });
              
            setIniciativas(inisOrdenadasSucesso);
            setTamanho(inisOrdenadasSucesso.length);
