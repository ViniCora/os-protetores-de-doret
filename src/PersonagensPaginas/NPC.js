...
function Personagem({Nome}){
    ...
    const retrieveAtributes = () => {
        ...
        .then((response) => {
        console.log(response.data[0].armas);
    ...
    function alteraValorArmas(){
        ...
        NPCDataService.updateArmas(atributes._id, {value: armas})
        .then((response) => {
    ...
    function atualizarInventario(){
        NPCDataService.updateInventario(atributes._id, {value: inventario})
        .then((response) => {
            ...
            </div>
            {
                ...
                paddingLeft: '10px', paddingRight: '10px', marginTop: '20px', marginBottom: '50px', backgroundColor: '#363636'}}>  
                    ...
                    <AtributosNPC id={atributes._id} Força={atributes.força} Destreza={atributes.destreza} Carisma={atributes.carisma} Inteligencia={atributes.inteligencia} 
                        ...
                        vidaTotal={atributes.vida_total} sanidadeMaxima={atributes.sanidade_maxima}></AtributosNPC>
                </div>
            }
        </div>
    );
