...
function CadPlayer(){
    ...
    const retrievePoints = () => {
      ConstanteDataService.getConstante("pontosAtributos")
      .then((response) => {
  ...
  function pontosUsados(){
    ...
    return(
        ...
        width:'800px', height: '30%', borderColor: '#fff', borderRadius: '8px', borderStyle: 'solid', borderWidth: '2px', paddingTop: '10px'}}>
            ...
            <DivNomeEBaseCad Atributo="Ofício" Value={oficioBase} setValue={setOficioBase}></DivNomeEBaseCad>
            <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', paddingTop: '20px', paddingBottom: '50px'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
                <label style={{fontSize: '30px', color: '#fff'}}>{`Total de pontos de atributos para distribuir: `}</label>
            ...
            <DivAtributosCad Atributo="Constituição" Value={resistencia} setValue={setResistencia} setPoints={setPoints}></DivAtributosCad>
            <DivAtributosCad Atributo="Poder" Value={mira} setValue={setMira} setPoints={setPoints}></DivAtributosCad>
            <DivAtributosCad Atributo="Sorte" Value={oficio} setValue={setOficio} setPoints={setPoints}></DivAtributosCad>
