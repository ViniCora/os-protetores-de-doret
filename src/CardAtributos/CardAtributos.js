...
function CardAtributos({Atributo, Banco, Value, id, Adicionar, setAdicionar, nome, imagePath, vidaTotal, sanidadeAtual}){
    ...
    function alterarValorBanco(newValue){
        switch (Banco) {
             case 'vida':
                AtributesDataService.updateVidaTotal(id, {value: newValue})
                .then((response) => {
              ...
              break;
              case 'constituicao':
                AtributesDataService.updateConstituicao(id, {value: newValue})
                .then((response) => {
              ...
              break;
              case 'poder':
                AtributesDataService.updatePoder(id, {value: newValue})
                .then((response) => {
              ...
              break;
              case 'sorte':
                AtributesDataService.updateSorte(id, {value: newValue})
                .then((response) => {
              ...
              break;
              case 'lutar':
                AtributesDataService.updateLutar(id, {value: newValue})
                .then((response) => {
              ...
              case 'primeiros_socorros':
                AtributesDataService.updatePrimeirosSocorros(id, {value: newValue})
                .then((response) => {
